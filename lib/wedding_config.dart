  ...
  static final List<WeddingEvent> events = [
    ...
    WeddingEvent(
      ...
      schedule: [
        ...
        ScheduleItem('4:00 PM', 'Off to Lahore'),
        ScheduleItem('6:00 PM', 'Reception'),
        ScheduleItem('6:30 PM', 'Bhangra'),
        ScheduleItem('7:30 PM', 'Nikkah'),
        ScheduleItem('8:00 PM', 'Dinner'),
        ScheduleItem('9:00 PM', 'Doodh Pilai'),
        ScheduleItem('9:30 PM', 'Rukhsati'),
        ScheduleItem('10:00 PM', 'Off to Gujranwala'),
